...
const ProjectSubmission = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setToast({
        message: response.message || "Project submitted successfully!",
        type: "success",
      });
    } catch (error) {
      setToast({
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="mb-8 text-center sm:text-left">
          ...
          <p className="mt-2 text-base text-slate-600 max-w-2xl leading-relaxed">
            Provide detailed information about your startup or project.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-10 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <FormTextarea
              ...
              required
              rows={5}
              placeholder="Describe your project in detail. Include core objectives, target audience, unique value proposition, and competitive advantage..."
              className={INPUT_STYLES}
            />
              ...
              >
                {isSubmitting ? (
                  <>
                    ...
                    <span className="tracking-wide">Submitting Project...</span>
                  </>
                ) : (
                  <>
