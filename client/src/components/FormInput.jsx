    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="relative">
        <input
          ...
          required={required}
          className={`w-full px-4 py-3 bg-[#131c31] border rounded-2xl text-xs sm:text-sm text-white placeholder:text-[#52637c] focus:outline-none transition-all duration-200 ${
            hasError
