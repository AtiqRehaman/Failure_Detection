  ...
  async createProject(req, res, next) {
    try {
      ...
      const projectData = {
        ...
        target_market_size: req.body.targetMarketSize,
        budget: req.body.budget,
        employees_count: req.body.employeesCount,
        founder_experience_years: req.body.founderExperienceYears,
...
function generateProjectAnalysis(project) {
  ...
  const generateRecommendations = (project, riskLevel) => {
    ...
    if (project.industry === "Manufacturing") {
      recommendations.push({
        ...
        priority: "High",
        description:
          "Implement lean manufacturing principles to reduce waste and improve operational efficiency",
      });
      recommendations.push({
        category: "Supply Chain Management",
        priority: "High",
        description:
          "Diversify suppliers and implement inventory management systems to reduce supply chain risks",
      });
      recommendations.push({
        category: "Quality Control",
        priority: "High",
        description:
          "Invest in automated quality control systems to maintain product consistency and reduce defects",
      });
      recommendations.push({
        category: "Technology Integration",
        priority: "Medium",
        description:
          "Explore IoT and smart manufacturing solutions to modernize production processes and improve efficiency",
      });
      recommendations.push({
        category: "Workforce Development",
        priority: "Medium",
        description:
          "Invest in employee training and skill development to address labor shortages and improve productivity",
      });
      ...
      recommendations.push({
        ...
        priority: "High",
        description:
          "Invest in R&D and stay updated with emerging technologies to maintain competitive edge",
      });
      recommendations.push({
        category: "Market Strategy",
        priority: "High",
        description:
          "Focus on targeted marketing campaigns to reach your core audience effectively",
      });
      recommendations.push({
        category: "Financial Planning",
        priority: "High",
        description:
          "Optimize budget allocation for maximum ROI and sustainable growth",
      });
    } else {
      recommendations.push({
        category: "Market Strategy",
      ...
      recommendations.push({
        ...
        priority: "Medium",
        description:
          "Differentiate your offering with a unique value proposition",
      });
    }
    ...
    if (riskLevel === "High") {
      recommendations.push({
        ...
        priority: "High",
        description:
          "Develop a comprehensive risk management strategy to address potential challenges",
      });
    }
    ...
    if (project.budget && project.budget < 100000) {
      recommendations.push({
        ...
        priority: "High",
        description:
          "Consider seeking additional funding from investors or explore bootstrapping options",
      });
      ...
      recommendations.push({
        ...
        priority: "Medium",
        description:
          "Optimize resource allocation to ensure efficient use of available capital",
      });
    }
    ...
    if (project.business_model === "B2B") {
      recommendations.push({
        ...
        priority: "High",
        description:
          "Develop a strong B2B sales strategy and build relationships with key decision-makers",
      });
      ...
      recommendations.push({
        ...
        priority: "High",
        description:
          "Focus on customer experience and build brand loyalty through engagement",
      });
    }
  ...
  const calculateSuccessProbability = (project) => {
    ...
    // Industry factor
    if (["Technology", "Healthcare", "SaaS"].includes(project.industry))
      score += 10;
    else if (
      ["Education", "Energy", "E-commerce", "Manufacturing"].includes(
        project.industry,
      )
    )
      score += 5;
    ...
    if (["B2B", "SaaS", "Subscription"].includes(project.business_model))
      score += 10;
    else if (["B2C", "Marketplace"].includes(project.business_model))
      score += 5;
